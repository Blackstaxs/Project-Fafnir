...
Shader "RRF_HumanShaders/EyeShaders/EyeShader_Model3a"
{
	Properties
	{
		...
		_EyeShadingPower("EyeShadingPower", Range( 0.01 , 2)) = 1
		_EyeShadingAdjust("EyeShadingAdjust", Range( -2 , 2)) = 0.5
		_EyeShadingBias("EyeShadingBias", Range( -2 , 2)) = 1.2
		_MinimumGlow("MinimumGlow", Range( 0 , 1)) = 0.2
		_MicroScatterScale("MicroScatterScale", Range( 0 , 1)) = 0
		_EyeShadingFres("EyeShadingFres", Vector) = (1.2,-1,1,0)
		_Eyeball_microScatter("Eyeball_microScatter", Range( 0 , 5)) = 0
		_EyeShadingAffectsAll("EyeShadingAffectsAll", Range( 0 , 1)) = 0.7
	...
	SubShader
	{
		...
		uniform float _EyeShadingAdjust;
		uniform float _EyeShadingBias;
		uniform float _EyeShadingPower;
		uniform float3 _EyeShadingFres;
		...
		uniform float _EyeShadingAffectsAll;
...
#define _MinimumGlow_arr RRF_HumanShadersEyeShadersEyeShader_Model3a
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_880_0 = saturate( ( ase_worldNormal.y + _EyeShadingAdjust ) );
			float temp_output_860_0 = ( 1.0 - temp_output_880_0 );
			float lerpResult873 = lerp( temp_output_880_0 , temp_output_860_0 , _EyeShadingBias);
			float3 temp_cast_6 = (lerpResult873).xxx;
			float temp_output_2_0_g45 = _EyeShadingPower;
			...
			float fresnelNode866 = ( _EyeShadingFres.x + _EyeShadingFres.y * pow( 1.0 - fresnelNdotV866, _EyeShadingFres.z ) );
			float3 temp_cast_7 = (fresnelNode866).xxx;
			float temp_output_2_0_g44 = saturate( _EyeShadingPower );
			...
			float3 eyeShading672 = saturate( ( ( ( temp_cast_6 * temp_output_2_0_g45 ) + appendResult7_g45 ) * ( ( temp_cast_7 * temp_output_2_0_g44 ) + appendResult7_g44 ) ) );
			...
			float dotResult4_g24 = dot( ase_worldlightDir , temp_cast_9 );
			...
			float2 temp_cast_12 = (eyeSizing616).xx;
			float2 uv_TexCoord190 = i.uv_texcoord * temp_cast_12 + ( ( ParallaxPush_Vec2580 * float2( 0.15,0.15 ) ) + ( ( 1.0 - eyeSizing616 ) / 2.0 ) );
			...
			float dotResult5_g46 = dot( ase_worldlightDir , ase_vertexNormal );
			float _MinimumGlow_Instance = UNITY_ACCESS_INSTANCED_PROP(_MinimumGlow_arr, _MinimumGlow);
			float clampResult478 = clamp( ( ( 1.0 * dotResult5_g46 ) * PupilMaskArea625 ) , _MinimumGlow_Instance , 1.0 );
			float4 lerpResult568 = lerp( ( temp_output_326_0 * float4( ( clampResult478 * eyeShading672 ) , 0.0 ) ) , float4( 0,0,0,0 ) , eyeLimbalRingPower612);
			...
			float4 temp_output_803_0 = ( lerpResult787 * ase_lightColor );
			float4 lerpResult895 = lerp( temp_output_803_0 , ( temp_output_803_0 * float4( eyeShading672 , 0.0 ) ) , _EyeShadingAffectsAll);
			o.Albedo = lerpResult895.rgb;
			...
			float4 temp_output_846_0 = ( ( ( ( caustEmissission827 * causticInDark824 ) + ( ase_lightColor * PreEmissive804 ) ) * PupilMaskArea625 ) + PupilGlow833 );
			float4 lerpResult889 = lerp( temp_output_846_0 , ( float4( eyeShading672 , 0.0 ) * temp_output_846_0 ) , _EyeShadingAffectsAll);
			o.Emission = lerpResult889.rgb;
...
/*ASEBEGIN
Version=18912
0;556.6667;1908;769;2866.332;-2515.585;1.3;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-3461.919,-655.2391;Float;False;Property;_EyeSize;EyeSize;12;0;Create;True;0;0;0;False;0;False;1;1.34;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;543;-5604.761,-1418.477;Float;False;Property;_PupilAutoDilateFactor;PupilAutoDilateFactor;27;0;Create;True;0;0;0;False;0;False;0;22.7;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-5598.821,-1329.853;Half;False;Property;_PupilSize;PupilSize;24;0;Create;True;0;0;0;False;0;False;70;78.6;0.001;99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;535;-5604.813,-1241.473;Float;False;Property;_PupilAffectedByLight_Amount;PupilAffectedByLight_Amount;28;0;Create;True;0;0;0;False;0;False;0;0.413;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;257;-5668.911,-1030.676;Float;False;Property;_PupilParallaxHeight;PupilParallaxHeight;31;0;Create;True;0;0;0;False;0;False;2.5;1.89;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;247;-3471.69,-774.9874;Float;False;Property;_IrisSize;IrisSize;13;0;Create;True;0;0;0;False;0;False;1;2.98;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;419;-4996.699,-631.905;Float;False;Property;_PushParallaxMask;PushParallaxMask;30;0;Create;True;0;0;0;False;0;False;1;2.76;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;884;-1850.171,3050.387;Float;False;Property;_EyeShadingAdjust;EyeShadingAdjust;35;0;Create;True;0;0;0;False;0;False;0.5;0.35;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;879;-2196.298,2745.258;Inherit;True;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;187;-1915.38,1314.087;Float;False;Property;_IrisExtraColorAmountA;IrisExtraColor-Amount(A);6;0;Create;True;0;0;0;False;0;False;0.08088237,0.07573904,0.04698314,0.591;0.1177552,0.1289852,0.1617647,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;170;-1908.036,772.9764;Float;False;Property;_EyeVeinColorAmountA;EyeVeinColor-Amount(A);7;0;Create;True;0;0;0;False;0;False;0.375,0,0,0;0.6838235,0.5329801,0.5329801,0.478;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;883;-1687.671,2913.887;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;213;-3061.348,-1158.257;Float;False;Property;_PupilSharpness;PupilSharpness;26;0;Create;True;0;0;0;False;0;False;5;0.75;0.1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;182;-3417.43,823.6976;Float;False;Property;_RingColorAmount;RingColor-Amount;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1544118,0.09196585,0.09196585,0.441;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;880;-1641.064,2785.786;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;126;-706.0718,1582.184;Float;False;Property;_IrisBaseColor;IrisBaseColor;5;0;Create;True;0;0;0;False;0;False;0.4999702,0.5441177,0.4641004,1;0.02205884,0.02002299,0.01638194,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;133;-3418.101,633.1917;Float;False;Property;_EyeBallColorGlossA;EyeBallColor-Gloss(A);4;0;Create;True;0;0;0;False;2;Header(Color Customization);Space(6);False;1,1,1,0.853;1,1,1,0.841;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;475;-1445.555,2695.934;Inherit;False;2220.814;763.4307;Eye Shading - Created local shadows around the eye (fake AO);13;672;871;483;866;861;467;860;872;873;882;885;897;898;Eye Shading;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;872;-1427.468,3021.977;Float;False;Property;_EyeShadingBias;EyeShadingBias;36;0;Create;True;0;0;0;False;0;False;1.2;1.23;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;467;-1336.429,3123.613;Float;False;Property;_EyeShadingPower;EyeShadingPower;34;0;Create;True;0;0;0;False;0;False;1;1.187;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;871;-639.3597,3021.268;Float;False;Property;_EyeShadingFres;EyeShadingFres;40;0;Create;True;0;0;0;False;0;False;1.2,-1,1;1.25,-1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.OneMinusNode;860;-1339.19,2792.365;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;866;-383.7699,2990.864;Inherit;True;Standard;WorldNormal;LightDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;-1.13;False;2;FLOAT;0.71;False;3;FLOAT;1.21;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;873;-716.5677,2746.297;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;898;-878.1266,3212.187;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;483;-430.4216,2750.388;Inherit;True;Lerp White To;-1;;45;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;897;-77.05424,3003.759;Inherit;True;Lerp White To;-1;;44;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-764.0728,2238.058;Float;False;Property;_CausticPower;CausticPower;21;0;Create;True;0;0;0;False;0;False;17;3.68;0.5;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;370;-650.2144,2062.136;Inherit;True;Property;_CausticMask;CausticMask;20;1;[NoScaleOffset];Create;True;0;0;0;False;1;Header(Caustic FX);False;-1;None;4567a6987e49477429e516f992aac3ab;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;885;-170.1818,2863.014;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;882;45.91711,2745.502;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;636;621.0922,1793.227;Inherit;False;LightDirectionZone_float;-1;;46;ce816473eb2cf6d4e96d84f2ab098aa5;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;638;1637.879,1474.012;Inherit;False;1022.617;442.3356;LocalShadowPass Extra limbal Ring effect;6;637;481;470;614;568;881;Shadow FX;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;672;275.5143,2737.312;Float;True;eyeShading;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;489;594.1643,1489.961;Float;False;InstancedProperty;_MinimumGlow;MinimumGlow;37;0;Create;True;0;0;0;False;0;False;0.2;0.432;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;750;-326.8658,2509.578;Float;False;Property;_CausticFX_inDarkness;CausticFX_inDarkness;22;0;Create;True;0;0;0;False;0;False;17;0.658;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;652;2682.394,1397.634;Inherit;False;950.9968;628.9937;Final Outputs and Pupil Color control;11;648;665;647;666;668;667;650;673;674;832;833;Final Gather;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;881;1707.172,1561.335;Inherit;False;672;eyeShading;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;647;2707.268,1444.284;Float;False;Property;_PupilColorEmissivenessA;PupilColor-Emissiveness(A);23;0;Create;True;0;0;0;False;2;Header(Pupil Control);Space(6);False;0,0,0,0;0.1323529,0.1187284,0.1187284,0.222;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;669;-43.51121,-496.9287;Inherit;False;MicroScatterScale_vec2;38;;47;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;499;353.9738,-222.3932;Float;False;Property;_Eyeball_microScatter;Eyeball_microScatter;41;0;Create;True;0;0;0;False;0;False;0;1.12;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;848;3715.594,1390.391;Inherit;False;1443.159;515.8131;FinalEmissive;12;804;806;818;829;831;830;826;844;845;847;846;886;Final Emissive;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-753.7518,947.6635;Float;False;Property;_LensGloss;LensGloss;15;0;Create;True;0;0;0;False;0;False;0.98;0.913;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;724;-2111.768,155.1683;Float;False;Property;_IrisPupilMetalness;IrisPupilMetalness;18;0;Create;True;0;0;0;False;0;False;0;0.496;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;333;586.7011,158.6582;Float;False;Property;_ScleraBumpScale;ScleraBumpScale;11;0;Create;True;0;0;0;False;0;False;0;0.978;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;723;-2128.732,-215.2754;Float;False;Property;_LimbalRingMetalness;LimbalRingMetalness;17;0;Create;True;0;0;0;False;1;Header(Metalness);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-276.5095,369.9954;Float;False;Property;_LensPush;LensPush;16;0;Create;True;0;0;0;False;0;False;0.64;0.079;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;789;3885.831,1021.573;Float;False;Property;_SubSurfaceFromDirectionalLight;SubSurfaceFromDirectionalLight;43;0;Create;True;0;0;0;False;0;False;0.5;0.31;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;894;5380.52,1218.432;Inherit;False;672;eyeShading;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;886;4958.463,1591.233;Inherit;False;672;eyeShading;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;887;5182.714,1573.414;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;888;5063.69,1948.061;Inherit;False;Property;_EyeShadingAffectsAll;EyeShadingAffectsAll;42;0;Create;True;0;0;0;False;0;False;0.7;0.756;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;893;5637.386,1154.215;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;641;5225.239,1426.236;Inherit;False;640;NORMAL_OUTPUT;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;889;5427.808,1621.304;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;858;-1915.713,3216.223;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldToObjectTransfNode;900;-1941.165,2571.052;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;895;5933.773,1213.492;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;664;5503.88,1782.781;Inherit;False;663;METALNESS_OUTPUT;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;643;5486.05,1863.773;Inherit;False;642;SMOOTHNESS_OUTPUT;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;861;-1057.526,2730.449;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;6181.279,1606.051;Float;False;True;-1;2;;0;0;Standard;RRF_HumanShaders/EyeShaders/EyeShader_Model3a;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;873;0;880;0
WireConnection;873;1;860;0
WireConnection;873;2;872;0
WireConnection;898;0;467;0
...
WireConnection;885;0;483;0
WireConnection;885;1;897;0
